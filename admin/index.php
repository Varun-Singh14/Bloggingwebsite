...
//fetch current user's post from the database
$current_user_id = $_SESSION['user-id'];
$query = "SELECT id, title, category_id FROM posts WHERE posts.author_id=$current_user_id ORDER BY id DESC";
...
?>
    ...
    <section class="dashboard">
        ...
        <?php elseif(isset($_SESSION['add-post'])) : // show if add post was successful ?>
        ...
        <?php elseif(isset($_SESSION['delete-post'])) : // show if delete post was successful ?>
            <div class="alert__message error container">
                <p>
