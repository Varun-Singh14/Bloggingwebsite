...
if(isset($_POST['submit'])) {
        ...
        if($thumbnail['name']) {
            ...
            if(in_array($extension, $allowed_files)) {
                ...
                if($thumbnail['size'] < 2000000){
                    ...
                    $_SESSION['edit-post'] = "File size too bog, should be less than 2mb";
                }
            }
            else {
    ...
    if(isset($_SESSION['edit-post'])) {
        //pass form data back to edit-post page
        ...
        //set thumbnail name if a new was uploaded, else keep old thumbnail name
